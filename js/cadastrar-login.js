...
function mostrar_senha(idsenha, idbutton){
  ...
  function validasenha(senha){
    ...
    if (senha.value.length < 8){
      document.getElementById('msgsenha').innerHTML = "Deve conter no mínimo oito caracteres!";
      erroSenha = 1;
      ...
      if (senha.value.match(chEspeciais)){
        if (senha.value.match(letrasMaiusculas)){
          if (senha.value.match(letrasMinusculas)){
            ...
            document.getElementById('msgsenha').innerHTML = "Deve conter no mínimo uma letra minuscula!";
            erroSenha = 1;
          }
        }else{
          document.getElementById('msgsenha').innerHTML = "Deve conter no mínimo uma letra maiúscula!";
          erroSenha = 1;
        }
      }else{
        document.getElementById('msgsenha').innerHTML = "Deve conter no mínimo um caracter especial!";
        erroSenha = 1;
      }
    }else{
      document.getElementById('msgsenha').innerHTML = "Deve conter no mínimo um número!";
      erroSenha = 1;
    }
  }
